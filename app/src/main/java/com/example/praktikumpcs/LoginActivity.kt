package com.example.praktikumpcs
...
import com.example.praktikumpcs.api.BaseRetrofit
import com.example.praktikumpcs.api.SessionManager
import com.example.praktikumpcs.response.login.LoginResponse
        ...
        btnLogin.setOnClickListener {
            ...
            api.login(txtEmail.text.toString(),txtPassword.text.toString()).enqueue(object :
                ...
                override fun onResponse(
                    ...
                    val correct = response.body()!!.success //TIDAK NULL
